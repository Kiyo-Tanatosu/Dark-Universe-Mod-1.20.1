...
public enum ModArmorMaterials implements ArmorMaterial {
    CORRUPT("corrupt", 55, new int[]{ 4, 9, 7, 4 }, 25,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 3f, 0.1f, () -> Ingredient.of(ModItems.CORRUPT_INGOT.get()));
    ...
    public String getName() {
        return DarkUniverse.MOD_ID + ":" + this.name;
    }
