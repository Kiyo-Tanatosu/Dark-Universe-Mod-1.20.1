package com.kiyotanatosu.darkuniverse.worldgen.portal;
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            for (BlockPos checkPos : BlockPos.betweenClosed(destinationPos.below(10).west(10),
                ...
                if (destinationWorld.getBlockState(checkPos).getBlock() instanceof CorruptPortalBlock) {
                    doSetBlock = false;
                    break;
                }
            }
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, ModBlocks.CORRUPT_ALTER.get().defaultBlockState(), 3);
            }
        }
